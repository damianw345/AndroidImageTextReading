...
public class ProcessPhotoActivity extends AbstractTesseractActivity {
    ...
    private static Bitmap rotateBitmap(Bitmap source, float angle) {
        ...
        Bitmap tmpRotatedBitmap = Bitmap.createBitmap(source, 0, 0, source.getWidth(), source.getHeight(), matrix, true);
        tmpRotatedBitmap.setHasAlpha(true);
        return tmpRotatedBitmap;
    }
}
