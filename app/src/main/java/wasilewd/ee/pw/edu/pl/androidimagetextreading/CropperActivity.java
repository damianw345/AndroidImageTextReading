...
//    private ToggleButton fixedAspectRatioToggleButton;
//    private TextView aspectRatioXTextView;
//    private SeekBar aspectRatioXSeekBar;
//    private TextView aspectRatioYTextView;
//    private SeekBar aspectRatioYSeekBar;
//    private Spinner guidelinesSpinner;
...
//        fixedAspectRatioToggleButton = (ToggleButton) findViewById(R.id.fixedAspectRatioToggle);
//        aspectRatioXTextView = (TextView) findViewById(R.id.aspectRatioX);
//        aspectRatioXSeekBar = (SeekBar) findViewById(R.id.aspectRatioXSeek);
//        aspectRatioYTextView = (TextView) findViewById(R.id.aspectRatioY);
//        aspectRatioYSeekBar = (SeekBar) findViewById(R.id.aspectRatioYSeek);
//        guidelinesSpinner = (Spinner) findViewById(R.id.showGuidelinesSpin);
//        cropImageView = (CropImageView) findViewById(R.id.CropImageView);
//        croppedImageView = (ImageView) findViewById(R.id.croppedImageView);
//        cropButton = (Button) findViewById(R.id.Button_crop);


        // ustaw obrazek zrodlowy
